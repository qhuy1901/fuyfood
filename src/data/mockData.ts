...
export const popularRestaurants: Restaurant[] = [
  ...
  },
  {
    ...
    distance: '4.3 km',
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTJawUY16xoWqTEBU0cNJlP7dFEq4m3u7GAg&s',
    tags: ['Dessert', 'Bakery'],
    isPromo: true,
  },
  {
  ...
  },
  {
    ...
    tags: ['Rice', 'Drinks', 'Dessert','Sushi', 'Chicken', 'BBQ', 'Hot Pot', 'Breakfast', 'Soft Drinks'],
    isFreeShipping: true,
    isPromo: true,
  },
  {
    ...
    tags: ['Rice', 'Drinks', 'Snacks', 'Dessert', 'Bakery', 'Steak', 'Chicken', 'Sandwiches', 'Hot Pot', 'Breakfast', 'Fast Food', 'Soft Drinks'],
    isFreeShipping: true,
  },
  {
    id: 'r31',
    ...
    tags: ['Rice', 'Drinks', 'Steak', 'Breakfast'],
    isPromo: true,
  },
  {
    id: 'r32',
  ...
  },
  {
    ...
    deliveryTime: '30-35 min',
    distance: '4.2 km',
    imageUrl: 'https://image.bnews.vn/MediaUpload/Org/2021/01/23/the-coffee-house2.jpg',
  ...
  },
  {
    ...
    deliveryTime: '20-27 min',
    distance: '1.8 km',
    imageUrl: 'https://jj-kitchen.tokyo/wp-content/uploads/sakura_bento2-1500x1125.jpg',
    tags: ['Bento', 'Healthy'],
    isFreeShipping: true,
  },
    {
  ...
  },
  {
    ...
    distance: '7.0 km',
    imageUrl: 'https://mms.img.susercontent.com/vn-11134513-7r98o-lsu86waq59cp17@resize_ss1242x600!@crop_w1242_h600_cT',
    tags: ['Noodles', 'Free Shipping', 'Ramen'],
    isPromo: true,
  },
  {
    id: 'r72',
  ...
  },
  {
    id: 'r74',
    name: 'Afuri Ramen',
    cuisine: 'Japanese • Ramen • Healthy',
    rating: 4.7,
    deliveryTime: '20-28 min',
    distance: '1.1 km',
    imageUrl: 'https://images.unsplash.com/photo-1552611052-33e04de081de',
  ...
  },
  {
    ...
    cuisine: 'Coffee • Drinks • Bakery',
    rating: 4.8,
    deliveryTime: '23-25 min',
    distance: '3.9 km',
    imageUrl: 'https://cdn.prod.website-files.com/64df83e71198a43e07d5bf11/66b5869d96dabdfaba99d8fc_66b575bb3d98c3755bc52059_66b57170caa197a1034e8a64_Abdul%252520Hameed%252520Al%252520Ali.jpeg',
    tags: ['Drinks', 'Bakery'],
    isTopRated: true,
  },
  {
    ...
    deliveryTime: '12-18 min',
    distance: '3.7 km',
    imageUrl: 'https://mindtrip.ai/attractions/1190/3f80/2247/97a4/9b18/cd0f/f7d8/a6aa',
    tags: ['Drinks'],
    isFreeShipping: true,
  },
  {
    id: 'r77',
    name: 'Domino’s Japan Pizza',
    cuisine: 'Pizza • Fast Food',
    rating: 4.5,
    deliveryTime: '25-35 min',
    distance: '3.5 km',
    imageUrl: 'https://www.dominos.jp/ManagedAssets/JP/product/1646/JP_1646_en_menu_13790.jpg?v789759014',
    tags: ['Pizza'],
    isPromo: true,
  },
  {
  ...
  {
    id: 'r79',
    name: 'LeTAO Cheesecake',
    cuisine: 'Dessert • Bakery • Sweets',
    rating: 4.9,
    deliveryTime: '18-25 min',
    distance: '2.8 km',
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhajPOYx9czoB5ysPGK5maEG0yCLnliAPAFw&s',
    tags: ['Dessert', 'Bakery'],
    isTopRated: true,
  },
  {
    ...
    cuisine: 'Desserts • Bakery • Chocolate',
    rating: 4.8,
    deliveryTime: '20-28 min',
    distance: '1.6 km',
  ...
  },
  {
    ...
    cuisine: 'Desserts • Snacks • Bakery',
    rating: 4.7,
    deliveryTime: '25-30 min',
    distance: '4.6 km',
    imageUrl: 'https://soranews24.com/wp-content/uploads/sites/3/2013/04/mister-donuts.jpg',
    tags: ['Dessert', 'Snack', 'Bakery'],
    isFreeShipping: true,
  },
  {
    id: 'r83',
    name: 'Soup Stock Tokyo',
    cuisine: 'Healthy • Soups • Rice',
    rating: 4.8,
    deliveryTime: '18-25 min',
    distance: '5.0 km',
    imageUrl: 'https://images.unsplash.com/photo-1547592166-23ac45744acd',
  ...
  {
    id: 'r84',
    name: 'Dean & Deluca Japan',
    cuisine: 'Bakery • Healthy • Cafe',
    rating: 4.7,
    deliveryTime: '20-28 min',
    distance: '1.2 km',
    imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd',
  ...
  {
    id: 'r85',
    name: 'Eggs ’n Things Japan',
    cuisine: 'Dessert • Pancakes • Cafe',
    rating: 4.6,
    deliveryTime: '22-30 min',
    distance: '1.4 km',
    imageUrl: 'https://images.unsplash.com/photo-1525351484163-7529414344d8',
  ...
  },
  {
    ...
    distance: '0.6 km',
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJdupHUXcDN9jrLiLrRzasGxb0ZJz3hFZH7g&s',
    tags: ['Drinks'],
    isFreeShipping: true,
  },
  {
    id: 'r89',
    name: 'Freshness Burger Japan',
    cuisine: 'Fast Food • Healthy • Rice',
    rating: 4.5,
    deliveryTime: '18-25 min',
    distance: '1.3 km',
    imageUrl: 'https://images.unsplash.com/photo-1550547660-d9450f859349',
  ...
  },
  {
    id: 'r90',
    name: 'MOS Burger',
    cuisine: 'Japanese • Fast Food • Rice',
    rating: 4.7,
    deliveryTime: '15-22 min',
    distance: '1.8 km',
    imageUrl: 'https://images.unsplash.com/photo-1550547660-d9450f859349',
    tags: ['Rice', 'Fast Food', 'Burgers'],
    isPromo: true,
  },
  {
    id: 'r91',
    name: 'Cafe Kitsune',
    cuisine: 'Coffee • Drinks • Dessert',
    rating: 4.8,
    deliveryTime: '30-35 min',
    distance: '5.7 km',
    imageUrl: 'https://www.vmcdn.ca/f/files/via/images/food/cafe-kitsune-food-drinks.jpg;w=800',
    tags: ['Drinks', 'Dessert'],
  },
  {
    id: 'r92',
    name: 'Harbs Cake Shop',
  ...
  {
    id: 'r93',
    name: 'Tully’s Coffee Japan',
    cuisine: 'Coffee • Drinks • Snacks',
    rating: 4.6,
    deliveryTime: '20-25 min',
    distance: '2.6 km',
    imageUrl: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/de/cc/1a/caption.jpg?w=600&h=600&s=1',
    tags: ['Drinks', 'Snack'],
  },
  {
    id: 'r94',
    name: 'Yakitate Japan Bakery',
    cuisine: 'Bakery • Bread • Snacks',
    rating: 4.7,
    deliveryTime: '16-22 min',
    distance: '0.8 km',
    imageUrl: 'https://images.unsplash.com/photo-1509440159596-0249088772ff',
  ...
  },
  {
    id: 'r95',
    name: 'Hoshino Coffee',
    cuisine: 'Cafe • Drinks • Dessert',
    rating: 4.7,
    deliveryTime: '27-30 min',
    distance: '4.9 km',
    imageUrl: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/29/83/88/6b/front-view.jpg?w=900&h=500&s=1',
    tags: ['Drinks', 'Dessert'],
  },
  {
    id: 'r96',
    name: 'Tempura Tendon Tenya',
    cuisine: 'Japanese • Rice • Tempura',
    rating: 4.6,
    deliveryTime: '20-28 min',
    distance: '1.2 km',
    imageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947',
  ...
  },
  {
    ...
    cuisine: 'Dessert • Buffet • Cakes',
    rating: 4.7,
    deliveryTime: '20-28 min',
    distance: '2.1 km',
    imageUrl: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2e/85/a6/1c/caption.jpg?w=900&h=500&s=1',
    tags: ['Dessert'],
    isPromo: true,
  },
  {
    id: 'r99',
    name: 'Matcha House Japan',
    cuisine: 'Dessert • Drinks • Matcha',
    rating: 4.8,
    deliveryTime: '15-22 min',
    distance: '0.7 km',
  ...
  {
    id: 'r100',
    name: 'Healthy Bowl Tokyo',
    cuisine: 'Healthy • Rice • Salad',
    rating: 4.7,
    deliveryTime: '30-35 min',
    distance: '5.0 km',
    imageUrl: 'https://images.deliveryhero.io/image/fd-my/LH/t5sv-listing.jpg',
    tags: ['Healthy', 'Rice'],
    isFreeShipping: true,
  },
  {
    id: 'r101',
    name: 'Tokyo Street Snacks',
    cuisine: 'Snacks • Street Food • Dessert',
    rating: 4.6,
    deliveryTime: '12-20 min',
    distance: '0.6 km',
    imageUrl: 'https://www.agoda.com/wp-content/uploads/2024/04/takoyaki-tokyo.jpg',
    tags: ['Snack', 'Dessert'],
    isPromo: true,
  },
];
