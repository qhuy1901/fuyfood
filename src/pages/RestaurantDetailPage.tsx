...
export default function RestaurantDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)]">
            ...
            <div className="text-white">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex items-center gap-1 bg-[var(--color-tertiary-container)] px-3 py-1 rounded-full text-[10px] font-bold">
                  ...
                  <span>4.9 (2.5k+ Sold)</span>
                </div>
              </div>
              <h1 className="font-black text-4xl md:text-6xl tracking-tight mb-2" style={{ fontFamily: 'var(--font-headline)' }}>Urban Umami</h1>
                ...
                <section key={section}>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {items.map(item => (
                      <div
                        key={item.id}
                        className="bg-[var(--color-surface-container-lowest)] p-4 rounded-2xl flex gap-4 hover:shadow-xl transition-all group relative border border-transparent hover:border-[var(--color-outline-variant)]/20"
                      >
                        ...
                        <div className="flex flex-col justify-between flex-1 py-1">
                          <div>
                            <h3 className="font-bold text-lg leading-tight mb-1" style={{ fontFamily: 'var(--font-headline)' }}>{item.name}</h3>
      ...
      {/* Sticky Cart Bar */}
      <div className="fixed bottom-0 left-0 w-full z-50 px-4 pb-6 pt-3 md:pb-8">
        <div className="max-w-screen-xl mx-auto bg-neutral-900 text-white rounded-2xl shadow-2xl flex items-center justify-between p-4 md:p-5">
